...
const AGENDA = [
  ...
  { t: "04", label: "Тренды: реальная ценность, а не копирование" },
      ...
      <div className="grid min-h-0 flex-1 gap-4 lg:grid-cols-2">
        <article className="glass-deep hud-corners flex flex-col justify-between rounded-3xl p-5 md:p-6">
          ...
          <ul className="mt-6 space-y-3 text-sm text-paper/90 md:text-[15px]">
            ...
            <li>Топливный баланс, производственная программа, тариф, капитальное строительство</li>
        ...
        <article className="glass-deep hud-corners glow-gold flex flex-col justify-between rounded-3xl border-gold/45 p-5 md:p-6">
          ...
          <ul className="mt-6 space-y-3 text-sm text-paper md:text-[15px]">
            <li>Готовность оборудования и дефект — до отказа оборудования</li>
            <li>Прогнозирование на рынке электроэнергии, гибкость финансовых потоков, сценарное моделирование производственной программы</li>
            <li>Новые системы и сервисы для компаний — в сроки недель, а не лет</li>
          </ul>
        </article>
      </div>
...
const DOMAINS = [
  {
    ...
    d: "Способности Холдинга: генерация, теплоснабжение, сети, сбыт, надёжность, финансы. Не организационная схема.",
  },
  {
    n: "02",
    t: "Прикладная",
    d: "Доменные системы и интегрируемые сервисы. Не единая система планирования ресурсов предприятия на все компании, а стыковка по правилам.",
  },
  {
    n: "03",
    t: "Данные",
  ...
  },
  {
    n: "04",
    t: "Интеграция",
    d: "Программные интерфейсы приложений и события вместо соединений «точка — точка». Промышленная площадка: промышленный стандарт обмена. Офис: шлюз интерфейсов.",
  },
  {
    n: "05",
    t: "Платформа",
    d: "Гибрид: вычисления на площадке, частное облако. Периметр технологического контура соблюдён.",
  },
  {
    n: "06",
    t: "Безопасность",
    d: "Сегментация промышленного контура. Принцип нулевого доверия в корпоративном контуре.",
  },
  {
    n: "07",
            ...
            {[
              {
                ...
                d: "Согласованные витрины: актив, точка учёта, контрагент, производство, финансы, надёжность. Историческая и аналитическая основа решений.",
              },
              {
                n: "02",
                tone: "text-cyan",
...
const TRENDS = [
  ...
  },
  {
    ...
    d: "Общий язык пром.площадки и офиса; промышленный стандарт обмена данными.",
  },
  {
...
const STAGES = [
  { n: "0", t: "Старт", d: "Инвентаризация информационного и операционного ландшафта, совет с правом вето, мораторий на соединения «точка — точка»." },
  ...
  { n: "3", t: "Платформа поставки", d: "Непрерывная поставка изменений, внутренняя платформа как сервис." },
  { n: "4", t: "Домены", d: "Постепенное замещение новыми цифровыми решениями с учётом приоритета ценности для бизнес-функции." },
  { n: "5", t: "Искусственный интеллект", d: "Портал и маркетплейс сервисов — только на подготовленных данных хранилища." },
...
const POLICIES = [
  {
    ...
    p: "Области интересов Холдинга, приоритеты доменов, принципы архитектуры, порядок финансирования платформы и хранилища.",
  },
  {
    h: "Стратегия данных",
  ...
  },
  {
    ...
    p: "Сегментация, шлюзы, однонаправленная передача, привилегированный доступ, промышленный регламент изменений.",
  },
  {
  ...
  return (
    <SlideShell className="gap-3 md:gap-4">
      ...
      <p className="text-xs leading-relaxed text-paper/70 md:text-sm">
        ...
        информационной безопасности, главный инженер и операционный директор.
      ...
      <ol className="grid gap-3 md:grid-cols-3">
        {[
          ...
          },
          {
            ...
            d: "Инвентаризация информационного и операционного ландшафта. Карта данных критичных процессов.",
          },
          {
            n: "03",
            t: "Пилотные проекты",
            d: "Обогащение хранилища, реализация коннекторов к данным, портал данных, портал искусственного интеллекта, проверка гипотезы и ценности.",
          },
        ].map((item) => (
